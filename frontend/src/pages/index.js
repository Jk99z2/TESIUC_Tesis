                        ...
                        <div >
                            <div id='Inicio' className='pt-20 md:pt-28 '>
                                <section className='xl:flex md:flex '>
                                    ...
                                    <div>
                                        <Image className="mt-4 mb-4 md:w-[auto] " src={escalera} alt='Imagen de Subiendo Libros'/>
                                    </div>
                                </section>
                            </div>
                            <div id='¿Qué es TESIUC?' className='pt-20 md:pt-28'>
                                <section  className='xl:flex'>  
                                    ...
                                    <div className='xl:ml-6'>
                                        <Image className="mt-1 mb-4 h-72 xl:w-[1000px] md:h-[550px] xl:h-[800px]" src={queestesiuc} alt='Imagen que es tesiuc'/>
                                    </div>
                                </section>  
                            </div>
                            <div id='¿Por qué TESIUC?' className='pt-20 md:pt-28'>
                                <section  className='xl:flex'>
                                    ...
                                    <div className='xl:ml-6 '>
                                        <Image className="mt-1 mb-4 h-72 xl:w-[1000px] md:h-[400px] xl:h-[800px]" src={porquetesiuc} alt='Imagen de porque'/>
                                    </div>
                                </section>
                            </div>
                            <div id='Contacto' className='pt-20 md:pt-28'>
                                <section  className='xl:flex'>
                                    <div className='xl:mt-8 xl:w-[40%]'>
                                        ...
                                        <div className='xl:ml-6'>
                                            <Image className="mt-1 mb-4 h-72 xl:w-[1000px] md:h-[500px] xl:h-[800px]" src={contac} alt='Imagen de contactos'/>
                                        </div>
                                </section>
                            </div>
                        </div>                       
