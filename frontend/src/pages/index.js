    ...
    return (
        ...
        {/*<div className="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
            ...
            <GuestLayout>         
                        ...
                        <h1 className=' text-[45px] text-gray-900 pb-7 font-bold'>Sistema para la Gestión de</h1>
                            <h1 className=' text-[45px] text-gray-900 font-bold'>Tesis de la Universidad de Colima</h1>
