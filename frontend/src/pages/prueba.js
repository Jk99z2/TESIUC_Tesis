...
export default function prueba() {
    return (
        <>
            <GuestLayout>
            <div className=" min-h-screen grid grid-rows-[60px,1fr]  lg:grid-rows-[70px,1fr] bg-zinc-400">
                    <div className=" ">
                        <nav className="bg-gray-900 fixed top-0 w-full h-[60px] lg:h-[70px]">navbar

                        </nav>
                        
                        
                    </div>
                    <div className="grid sm:grid-cols-[255px,1fr] lg:grid-cols-[255px,1fr] bg-red-300 ">
                        <div className="bg-purple-300 hidden sm:block">
                        ...
                        <div className="grid grid-rows-[1fr,60px] lg:grid-rows-[1fr,70px]">
                            <div className="bg-green-300">cuerpo
                                <div class="p-4">
